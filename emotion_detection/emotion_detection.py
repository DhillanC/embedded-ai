...
To manually test this file, on the CLI run:
python 3.11
import json
...
def emotion_detector(text_to_analyze):
    ...
    # Create a myobj dictionary with the text to be analyzed
    ...
    # Sends a POST request to the API with the text and headers
